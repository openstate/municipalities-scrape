...
try <- paste(str_split(gemeentes$use_url[[320]], "/")[[1]][1:3] , collapse = "/")
str_count(LinkExtractor(try)$Info$Source_page, "tel")
...
for (i in seq_along(gemeentes$use_url)) {
  if (!is.na(gemeentes$use_url[i]) & gemeentes$one_page == 0) {
